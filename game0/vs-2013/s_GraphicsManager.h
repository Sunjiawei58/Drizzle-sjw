...
namespace df{
	...
	public:
		...
		int drawCh_net(Position world_pos, char ch, s_Color color,unsigned int time_counter)const;
		...
		Position s_pixelsToSpaces(Position pixels) const;      // add these function into member function?
